add wave -position end  sim:/add4/propagation
add wave -position end  sim:/add4/input
add wave -position end  sim:/add4/clock
add wave -position end  sim:/add4/output
